...
function setupGUI() {
    ...
    h.add(effectController, "giroBase", -180.0, 180.0, 0.025).name("Giro Base en Y")
    h.add(effectController, "giroBrazo",-45.0, 45.0, 0.025).name("Giro Brazo en Z")
    h.add(effectController, "giroAnteBrazoY", -180.0, 180.0, 0.025).name("Giro antebrazo en Y")
    h.add(effectController, "giroAnteBrazoZ", -90.0, 90.0, 0.025).name("Giro antebrazo en Z")
    h.add(effectController, "giroPinza", -40.0, 220.0, 0.025).name("Giro pinza")
    h.add(effectController, "aperturaMano", 0, 15, 0.025).name("Apertura pinzas")
    h.add(effectController, "wireframe").name("Wireframe")
    h.add(effectController, "animar").name("Animate")
}
function init() {
