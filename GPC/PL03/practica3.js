...
function loadScene() {
    const material_robot = new THREE.MeshNormalMaterial({flatShading: true, wireframe:false})
    const material_2 = new THREE.MeshBasicMaterial({color:'blue', wireframe:false})
    ...
    const pinzaD = new THREE.Mesh(pinzaGeometry, material_robot)
